            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <tr dir-paginate = "nd in nguoidung |filter: q| itemsPerPage: pageSize" current-page="currentPage">
                        ...
                        <td><button class="btn btn-info" ng-click="showModal(nd.memberID)"><i class="fas fa-edit"></i></button></td>
                        <td><button class="btn btn-danger" ng-click="deleteClick(nd.memberID)"><i class="fas fa-trash-alt"></i></button></td>
                    </tr>
                </tbody>
            </table>
